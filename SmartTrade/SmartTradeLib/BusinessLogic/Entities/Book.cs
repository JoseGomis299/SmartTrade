...
{
    public Book(){}
    //public Book(string name, string certification, string ecologicPrint, int minimumAge, string howToUse, string, string author, string publisher, string pages, string language, string isbn) : base(name, certification, ecologicPrint, minimumAge, howToUse, howToReducePrint)
    //{
    //    Author = author;
    //    Publisher = publisher;
    //    Pages = pages;
